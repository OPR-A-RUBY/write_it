...
METHOD send 
  ...
  5.Создание объекта - (использование ХЭШ с функцией send)
	...
	class Something
		...
		# В предыдущем варианте длина кда не зависит от количества параметров (!)
	end	
	# =============================================================== B E G I N =====
...
# 6.Использование метода "method_missing" для отсутствующих методов класса
	# -------------------------------------------------------------------------------
	class Something
		...
  ...
  7.Использование метода "method_missing" для ....
	# -------------------------------------------------------------------------------
	class Albuquerque
